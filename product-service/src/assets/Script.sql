...
SELECT * FROM (select * from product_model where product_model.id='c68a4107-33f4-4103-8510-888a66b73777') product_model INNER JOIN stock_model ON product_model.id = stock_model.product_id